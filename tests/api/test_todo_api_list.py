...
class TestGetTodos:
    ...
    def test_get_all_todos(self, test_client, setup_sample_todos):
    ...
    def test_filter_by_status(self, test_client, setup_sample_todos):
    ...
    def test_filter_by_priority(self, test_client, setup_sample_todos):
    ...
    def test_combined_filters(self, test_client, setup_sample_todos):
        ...
        # assert all(
        #     todo['priority'] == 'high' and
        #     todo['status'] == 'not_started' and
        #     todo['due_date'] >= today
        #     for todo in data
        # )
    ...
    def test_invalid_priority_filter(self, test_client):
    ...
    def test_performance_with_many_todos(self, test_client, app):
